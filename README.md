...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/test-worker)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/test-worker
```

A live public deployment of this template is available at [https://test-worker.templates.workers.dev](https://test-worker.templates.workers.dev)
